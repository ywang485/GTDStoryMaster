  ...
  objectTypes: [
    ...
    // ========================================
    {
      ...
      assets: {
        stateAssets: {
          stage0: [
            { id: "seeds", type: "sprite", url: "/assets/farm/crops/crops.png", tileIndex: 8, tileSize: 16, tilesPerRow: 6 },
          ],
          stage1: [
            { id: "sprout", type: "sprite", url: "/assets/farm/crops/crops.png", tileIndex: 9, tileSize: 16, tilesPerRow: 6 },
          ],
          stage2: [
            { id: "growing", type: "sprite", url: "/assets/farm/crops/crops.png", tileIndex: 10, tileSize: 16, tilesPerRow: 6 },
          ],
          stage3: [
            { id: "maturing", type: "sprite", url: "/assets/farm/crops/crops.png", tileIndex: 11, tileSize: 16, tilesPerRow: 6 },
          ],
          stage4: [
            { id: "mature", type: "sprite", url: "/assets/farm/crops/crops.png", tileIndex: 12, tileSize: 16, tilesPerRow: 16 },
          ],
        },
        actionAssets: {
          plant: [
